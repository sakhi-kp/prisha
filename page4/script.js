document.addEventListener('DOMContentLoaded', function() {
    ...
    const config = {
        ...
        fadeInDelay: 500,
        pulseDelay: 1000,
        letterContent: `Prisha, we might've known each other for just a few weeks, but honestly, it already feels like we've shared so many laughs and moments. You have this super chill, fun vibe that makes people feel instantly comfortable — and that's rare.

I'm really glad we crossed paths. You're kind, full of life, and just a genuinely sweet person. So on your birthday, I just wanted to do a little something to make you smile (hope it worked 😅).

Happy Birthday, Prisha! 🎉
Hope this year brings you tons of happiness, growth, and unforgettable memories.

Looking forward to more random convos and laughs ahead 😄`,
        cursorChar: '|',
        particleCount: 100,
        confettiSpread: 70
    };
